...
export default function Articles() {
  ...
  return (
    <>
      ...
      <section className="articles p-2 min-[320px]:p-4 md:px-0 md:py-0 md:grid md:grid-cols-2 w-full h-full bg-[url('./assets/background.jpg')] bg-cover bg-center bg-no-repeat bg-fixed box-border items-center">
